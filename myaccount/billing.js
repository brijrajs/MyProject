...
app.models.Address = Backbone.Model.extend({
  url: function () {
    return '/rest/myaccount/billingAddresses/' + this.get('id');
  }
});
...
//    console.log('address ' + this.model.get('id') + ' render');
  ...
  'editAddress': function(){
    location.href = "/myaccount/address.do?type=billing&id=" + this.model.get('id');
  },
...
//    console.log('orders.render');
  ...
  'addAddress': function(){
    location.href = "/myaccount/address.do?type=billing";
  }
