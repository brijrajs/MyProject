...
function enablePleaseWaitMessage() {
  jQuery('body').append("<div class='PW_outer'><div class='PW_inner'>Communicating with server...<br /><img src='/myaccount/images/jquery.smallhbar.indicator.gif' alt='please wait'/></div></div>");
...
function showError(msg) {
  ...
  jQuery('.myaccount-notifications .error').html(msg).css('display', 'block');
}

function showWarning(msg) {
  jQuery('input.error').removeClass('error');
  jQuery('.error,.info,.success').css('display', 'none');
  jQuery('.myaccount-notifications .warning').html(msg).css('display', 'block');
}

function showInfo(msg) {
  jQuery('input.error').removeClass('error');
  jQuery('.warning,.error,.success').css('display', 'none');
  jQuery('.myaccount-notifications .info').html(msg).css('display', 'block');
}

function showSuccess(msg) {
  jQuery('input.error').removeClass('error');
  jQuery('.warning,.info,.error').css('display', 'none');
  jQuery('.myaccount-notifications .success').html(msg).css('display', 'block');
}
