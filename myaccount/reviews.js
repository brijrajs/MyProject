...
//    console.log('notReviewedYet ' + this.model.get('itemId') + ' render');
  ...
  'redirectToReview': function (event) {
    location.href = "/cgi-bin/UCReviewItem?merchantId=" + encodeURIComponent(this.model.get('merchantId')) + "&itemId=" + encodeURIComponent(this.model.get('itemId'));
  }
